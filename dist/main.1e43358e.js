...
var _default = {
  ...
  watch: {
    magnetInput: function magnetInput() {
      var _this = this;

      // magnet:?xt=urn:btih:4e19ac9addb274e78cf191fbda81d18c84724ed7
      clearTimeout(this.fetchThrottle);
      this.fetchThrottle = setTimeout(function (_) {
        _this.fetchMagnetContents(_this.magnetInput);
      }, 500);
    },
    playingUriSet: function playingUriSet(nv, ov) {
      var _this2 = this;

      clearTimeout(this.playingUriThrottle);
      if (!nv || !ov) return this.playingUri = nv;
      this.playingUriThrottle = setTimeout(function (_) {
        _this2.playingUri = nv;
      }, 750);
    }
  },
  computed: {
    ...
    closed: function closed() {
      if (this.currentlyPlaying && !this.nearEdge) return true;
      return false;
    },
    playingUriSet: function playingUriSet() {
      if (!this.currentlyPlaying) return false;
      return "http://localhost:8888/ffmpeg/".concat(this.currentlyPlaying.hash, "/").concat(this.currentlyPlaying.slug, "?s=").concat(this.currentlyPlaying.timeOffset, "&q=").concat(this.quality);
    }
  },
  created: function created() {
  ...
  methods: {
    playFile: function playFile(file) {
      this.currentlyPlaying = file;
    },
    inputBlur: function inputBlur() {
      this.magnetInputFocus = false; // this.fetchMagnetContents();
      // this.magnetInput = req.url.match(/btih:([a-z0-9]*)/i);
    },
    mouseMove: function mouseMove(e) {
      var _this3 = this;

      if (e && e.pageX < 300) this.nearEdge = true;else this.nearEdge = false;
      this.recentMouseMove = true;
      clearTimeout(this.moveThrottle);
      this.moveThrottle = setTimeout(function (_) {
        _this3.recentMouseMove = false;
      }, 5000);
    },
    fetchMagnetContents: function fetchMagnetContents(mag) {
      var _this4 = this;

      if (!mag.includes('magnet:?xt=urn:btih:')) return;
      fetch('http://localhost:8888/' + mag, {
        headers: {
        ...
        json.overlap = textOverLap(json.files.map(function (e) {
          return e.name;
        }));
    ...
    videoNext: function videoNext(fromEnd) {
      var _this5 = this;

      var fIdx = this.loadedTorrent.files.findIndex(function (f) {
        return f === _this5.currentlyPlaying;
      });
      if (fromEnd) this.currentlyPlaying.timeOffset = 0;
    ...
    videoRestart: function videoRestart() {
      this.currentlyPlaying.timeOffset = 0;
    },
    videoReplay: function videoReplay(mins) {
    ...
    videoForward: function videoForward(mins) {
    ...
    videoTogglePlay: function videoTogglePlay() {
      if (this.$refs.video.paused) return this.$refs.video.play();
      this.$refs.video.pause();
    },
    videoStop: function videoStop(err) {
      this.$refs.video.pause();
      ...
      if (err) this.currentlyPlaying.timeOffset = 0;
      this.currentlyPlaying = null;
    },
    secondInt: function secondInt() {
      if (!this.currentlyPlaying) return this.showPlayTime = null;
...
function textOverLap(arrayOfStrings) {
  var shortest = arrayOfStrings.map(function (e) {
    return e.length;
  }).sort().shift();
  var matched = '';
  var matchLength = 1;
  ...
  while (shortest > 0) {
    t = arrayOfStrings.filter(function (s) {
      return s.substring(0, matchLength) === arrayOfStrings[0].substring(0, matchLength);
    }).length;
    if (t === arrayOfStrings.length) matched = arrayOfStrings[0].substring(0, matchLength);
    shortest--;
    matchLength++;
  }
  ...
  return matched;
        ...
        var $7f8ebc = exports.default || module.exports;
      
      if (typeof $7f8ebc === 'function') {
        $7f8ebc = $7f8ebc.options;
      }
    
        /* template */
        Object.assign($7f8ebc, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    { attrs: { id: "wrap" }, on: { mousemove: _vm.mouseMove } },
    [
      _vm.currentlyPlaying && _vm.playingUri
        ? _c("div", { staticClass: "player-wrap" }, [
            _c("video", {
              ref: "video",
              attrs: { autoplay: "", src: _vm.playingUri },
              on: {
                click: _vm.videoTogglePlay,
            ...
            _c(
              "div",
              { staticClass: "buttons", class: { show: _vm.recentMouseMove } },
              [
                _c("div", [
                  _vm._v(
                    "\n        " +
                      _vm._s(
                        _vm.currentlyPlaying.name.replace(
                          _vm.loadedTorrent.overlap,
                          ""
                        )
                      ) +
                      "\n      "
                ...
                _vm._v(" "),
                _c("button", { on: { click: _vm.videoRestart } }, [
                  _vm._v("⏮️")
                ]),
                _vm._v(" "),
                _c(
                ...
                _vm._v(" "),
                _c("button", { on: { click: _vm.videoPause } }, [_vm._v("⏸️")]),
                _vm._v(" "),
                _c("button", { on: { click: _vm.videoPlay } }, [_vm._v("▶️")]),
                _vm._v(" "),
                _c("button", { on: { click: _vm.videoStop } }, [_vm._v("⏹️")]),
                _vm._v(" "),
                _c(
                  "button",
                  {
                ...
                _vm._v(" "),
                _c("button", { on: { click: _vm.videoNext } }, [_vm._v("⏭️")]),
                _vm._v(" "),
                _c("br"),
                _vm._v(" "),
                _c("span", [_vm._v(_vm._s(_vm.showPlayTime))])
              ]
            )
          ])
        : _vm._e(),
      ...
      _c(
        "div",
        {
          staticClass: "find-wrap",
          class: { collapsed: _vm.collapsed, closed: _vm.closed }
        },
        [
          _c(
            "div",
            { staticClass: "find-inner" },
            [
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.magnetInput,
                    expression: "magnetInput"
                  }
                ],
                attrs: { type: "search", placeholder: "Magnet Link" },
                domProps: { value: _vm.magnetInput },
                on: {
                  focus: function($event) {
                    _vm.magnetInputFocus = true
                  },
                  blur: _vm.inputBlur,
                  input: function($event) {
                    ...
                    _vm.magnetInput = $event.target.value
                  }
                }
              }),
              _vm._v(" "),
              _vm.loadedTorrent
                ? [
                    _c("h4", [
                      _vm._v(_vm._s(_vm.loadedTorrent.name) + "\n\n          "),
                      _c(
                        "select",
                        {
                          directives: [
                    ...
                    _c(
                      "ul",
                      _vm._l(_vm.loadedTorrent.files, function(file) {
                        return _c(
                          "li",
                          {
                            key: file.length + file.name,
                            class: { playing: _vm.currentlyPlaying === file },
                            on: {
                              click: function($event) {
                                _vm.playFile(file)
                              }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7f8ebc', $7f8ebc);
          } else {
            api.reload('$7f8ebc', $7f8ebc);
          }
        }
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
